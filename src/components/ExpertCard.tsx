...
import soonImage from "@/assets/soon.jpeg";
...
const ExpertCard = ({
  ...
  return (
    <div
      ...
      dir="rtl"
    >
      {/* Preview Image Section - دائماً موجود */}
      ...
      <div className="p-4 sm:p-5 md:p-6 flex-1 flex flex-col">
        {/* Badge, Type and Title in same row */}
        ...
        {/* إظهار زر الدخول فقط عندما يكون link موجود وليس null */}
